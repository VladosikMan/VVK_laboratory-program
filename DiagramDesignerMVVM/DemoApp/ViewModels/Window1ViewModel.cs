...
namespace DemoApp
{
    public class Window1ViewModel : INPCBase
    {
        ...
        public Window1ViewModel()
        {
            ...
            CompareDiagramCommand = new SimpleCommand(ExecuteCompareDiagramCommand);
        ...
        public SimpleCommand CompareDiagramCommand { get; private set; }
        ...
        public bool? ComparedDiagram
        {
	        get
	        {
		        return comparedDiagram;
	        }
	        set
	        {
		        if (comparedDiagram != value)
		        {
			        comparedDiagram = value;
			        NotifyChanged("ComparedDiagram");
		        }
	        }
        }
        ...
        private void ExecuteCompareDiagramCommand(object parameter)
        {
	        var diagram = new Diagram();
            
            GetDesignerItem(diagram.DiagramItem, diagramViewModel, diagram.Connections);

            ComparedDiagram = databaseAccessService.Compare(diagram);
            messageBoxService.ShowInformation($"Результат сравнения: {ComparedDiagram}");
        }
        ...
        private void GetDesignerItem(IDiagramItem designerItem, IDiagramViewModel diagramViewModel, List<Connection> connections)
        {
            ...
            foreach (var persistItemVM in diagramViewModel.Items.OfType<PersistDesignerItemViewModel>())
            {
                ...
                designerItem.DesignerItems.Add(new DiagramItemData(persistDesignerItem.Id, typeof(PersistDesignerItem)));
            }
            ...
            {
                GroupDesignerItem groupDesignerItem = new GroupDesignerItem(diagramViewModel.Items.IndexOf(groupingItemVM), groupingItemVM.Left, groupingItemVM.Top, groupingItemVM.ItemWidth, groupingItemVM.ItemHeight);
                if (groupingItemVM.Items != null && groupingItemVM.Items.Count > 0)
                {
                    SavePersistDesignerItem(groupDesignerItem, groupingItemVM);
                }
                designerItem.DesignerItems.Add(new DiagramItemData(groupDesignerItem.Id, typeof(GroupDesignerItem)));
            }
            ...
            foreach (var connectionVM in diagramViewModel.Items.OfType<ConnectorViewModel>())
            {
                ...
                Connection connection = new Connection(
                    diagramViewModel.Items.IndexOf(connectionVM),
                ...
                designerItem.ConnectionIds.Add(connectionVM.Id);
            }
        }
